...
```{r data_science, echo=FALSE, fig.cap="Ciencia de datos", fig.align = 'center', out.width = '300px'}
knitr::include_graphics("img/df_02_ds_1.png")
```
...
```{r trad_prog, echo=FALSE, fig.cap="Programación tradicional vs aprendizaje automático", fig.align = 'center', out.width = '300px'}
knitr::include_graphics("img/df_02_ml_1.png")
```
...
```{r ml_comp, echo=FALSE, fig.cap="Componentes del aprendizaje automático", fig.align = 'center', out.width = '300px'}
knitr::include_graphics("img/df_02_ml_2.jpg")
```
...
```{r ai_ml, echo=FALSE, fig.cap="Inteligencia artificial vs aprendizaje automático", fig.align = 'center', out.width = '300px'}
knitr::include_graphics("img/df_02_ds_2.jpg")
```
