...
```{r stats, echo=FALSE, fig.cap="Estadística", fig.align = 'center', out.width = '150px'}
...
```{r pm, echo=FALSE, fig.cap="Población vs muestra", fig.align = 'center', out.width = '300px'}
...
```{r rl, echo=FALSE, fig.cap="Regresión lineal", fig.align = 'center', out.width = '300px'}
