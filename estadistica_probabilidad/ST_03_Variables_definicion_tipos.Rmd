...
```{r eq, echo=FALSE, fig.cap="Variables", fig.align = 'center', out.width = '100px'}
knitr::include_graphics("img/equation.png")
```
...
Para ampliar más información consultar: `ST_04_Tipos_de_datos_en_ML.Rmd` y `ST_05_Escalas_medida.Rmd`.
...
```{r ind_dep, echo=FALSE, fig.cap="Variable dependiente vs independientes", fig.align = 'center', out.width = '300px'}
knitr::include_graphics("img/independent-and-dependent-variable.png")
```
...
Un ejemplo clásico en el que interviene una variable de confusión es el fenómenos de la paradoja de Simpson (`AM_02_Paradoja_Simpson.Rmd`), donde la omisión de una variable de confusión en el diseño de una investigación hace que el análisis agregado conduzca a una conclusión sesgada.
...
```{r table1, echo=FALSE, fig.cap="Resolución solicitudes de acceso según departamento y género", fig.align = 'center', out.width = '400px'}
knitr::include_graphics("img/vc_table_1.png")
```
...
```{r table2, echo=FALSE, fig.cap=" Datos admisión según departamento", fig.align = 'center', out.width = '400px'}
knitr::include_graphics("img/vc_table_2.png")
```
...
```{r table3, echo=FALSE, fig.cap=" Datos admisión según género", fig.align = 'center', out.width = '400px'}
knitr::include_graphics("img/vc_table_3.png")
```
...
- [_What is a Variable?_](https://statisticsbyjim.com/basics/what-is-a-variable/)
- [_Independent and Dependent Variables: Differences & Examples_](hhttps://statisticsbyjim.com/regression/independent-dependent-variables/)